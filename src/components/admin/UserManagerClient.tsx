        ...
        <div className="flex flex-col xl:flex-row gap-4 items-start xl:items-center justify-between w-full">
          ...
          {isAdmin && (
            <button
              ...
              className="w-full xl:w-auto bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-3 xl:py-2.5 rounded-xl font-bold flex items-center justify-center gap-2 text-sm transition-colors shadow-sm shrink-0"
            >
                    ...
                    <tr key={user.id} className="hover:bg-slate-50 transition-colors">
                      <td className="p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-bold text-slate-900 text-sm line-clamp-1">{user.name}</p>
                      ...
                      <td className="p-4">
                        {user.pets.length === 0 ? (
                          <span className="text-slate-400 text-xs whitespace-nowrap">Sin mascotas</span>
                        ) : (
                          <div className="flex flex-col gap-1">
                            {user.pets.slice(0, 2).map(pet => (
                              <div key={pet.id} className="flex items-center gap-1.5 whitespace-nowrap">
                                {pet.species === "dog"
                      ...
                      <td className="p-4">
                        {user.activeSubs > 0 ? (
                          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[10px] font-bold rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 whitespace-nowrap">
                            <Crown className="w-3 h-3" /> Suscrito
                          </span>
                        ) : (
                          <span className="px-2.5 py-1 text-[10px] font-bold rounded-full bg-slate-100 text-slate-500 border border-slate-200 whitespace-nowrap">
                            Gratuito
                          </span>
                        )}
                      </td>
